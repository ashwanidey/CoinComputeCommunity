...
const EachPerson = (props) => {
  ...
  return (
    ...
    <div className='flex gap-2 sm:gap-4 mb-3 items-center'  >
        ...
        <a href={`/profilepage/${person._id}`} className='text-decoration-none'>
        <div className='font-[600] md:text-[1.1rem] flex items-center '><span className='line-clamp-1'>{person.name}</span>
        ...
        <div className='text-[#808A9D] md:text-[1rem] text-[0.8rem]'>@{person.username}</div>
        </a>
        </div>
