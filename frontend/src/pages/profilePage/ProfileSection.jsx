    ...
    <div>
      ...
      <div>
        <div className='bg-[#cfd6e4] w-full pt-[33.33333%] relative rounded-[8px]'>
          <div className='absolute inset-[45%]'>IMAGE</div>
        </div>

        <div className='pl-[24px]'>


        <div class="grid grid-cols-[1fr,min-content,1fr] gap-x-8">
            <div class="grid grid-rows-2 gap-y-4">
            <div className="grid-item h-[100px] relative top-[-24px]">
              <div className='w-[140px] h-[140px] rounded-full bg-white overflow-hidden p-[4px]'>
            ...
            <div class="grid grid-rows-2 gap-y-4">
              <div class="grid-item pt-2">
                <p className='font-[600] text-[1.5rem]'>Full Name</p>
