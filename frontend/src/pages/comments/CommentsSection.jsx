...
import CreateComment from "./commentsSection/CreateComment";
        ...
        {!isLoading ? (
          <>
            ...
            <h1 class="my-4 text-2xl font-[900] leading-4 tracking-wider text-gray-900 md:text-3xl  dark:text-white">
              <mark class="px-2 text-white bg-gray-500 rounded dark:bg-blue-500">
                COMMENTS
              </mark>
            </h1>
            ...
            {comments.length !== 0 ? (
              ...
              <div className="font-[500] text-[1.2rem]">
                No <span className="text-blue-500">Comments</span> on this post
              </div>
            )}
          </>
        ) : (
