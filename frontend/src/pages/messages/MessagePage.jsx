...
const MessagePage = () => {
  ...
  return (
    <div className="min-h-[calc(-108px + 100vh)] dark:bg-[#0B161F] h-full flex overflow-y-hidden">
      ...
      {isLoggedIn ? (
        <div className="flex w-full ">
          <div
            className={`max-w-[1000px] w-full flex-grow-2 flex-shrink-1 flex-basis-0  dark:bg-[#0B161F]  md:px-[24px] px-[14px] py-[32px] ${
